...
export class NoMetaMaskError extends Error {
  public constructor() {
    super('Please download the latest version of Mises Browser to use this feature.')
...
export class MisesWallet extends Connector {
  ...
  private async isomorphicInitialize(): Promise<void> {
    ...
    return (this.eagerConnection = import('./detect-provider').then(async (m) => {
      ...
      if (provider) {
        this.provider = provider as unknown as MetaMaskProvider
